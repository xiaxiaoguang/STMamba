...
from GCNmamba import GCNmamba
import os
def TrainGCNMamba(train_dataloader, valid_dataloader, test_dataloader, 
    ...
    expand = 2
    n_layers = 4
    STmamba = GCNmamba(patch_size, in_channel ,num_len, pred_len,num_nodes,
    ...
    for epoch in range(num_epochs):
        ...
        for data in train_dataloader:
            ...
            if trained_number % interval == 0:
                ...
                with open(folder_path + "record1.txt",'a') as f:
        ...
        TestGCNMamba(STmamba,test_dataloader,max_speed,epoch , folder_path)

    return STmamba, [losses_train, losses_interval_train, losses_valid, losses_interval_valid]


def TestGCNMamba(STmamba, test_dataloader, max_speed,epoch, folder_path):
